...
interface MenuItem {
  ...
  icon: string;
  disabled: boolean;
  badge?: string | number | null; // ✅ Autoriser null
  adminOnly?: boolean; // ✅ Ajouter cette propriété
  action?: () => void;
}
 ...
 menuItems: MenuItem[] = [
    {
      ...
      disabled: false,
      badge: null // ✅ null est maintenant autorisé
    },
    {
      label: 'Catégories',
      route: '/categories',
    ...
    },
    {
      ...
      disabled: false, // ✅ Maintenant actif
      badge: null,
      adminOnly: true // ✅ adminOnly est maintenant autorisé
    },
    {
    label: 'Commandes',
    route: '/commandes',
  ...
  // Getter pour filtrer selon le rôle
  get filteredMenuItems(): MenuItem[] {
    if (!this.currentUser) return [];
    
    return this.menuItems.filter(item => {
      // Si l'item est réservé aux admins et l'utilisateur n'est pas admin
